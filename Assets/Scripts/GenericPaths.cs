...
public static class GenericPaths
{
    ...
    public static readonly string LevelsDataPath = streamingAssetsPath + @"\Levels.bin";
    public static readonly string SettingsPath   = streamingAssetsPath + @"\Settings.json";
}