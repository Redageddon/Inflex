...
public class SavedSettings
{
    ...
    public override string ToString() => $"{nameof(this.SkinName)}: {this.SkinName}, {nameof(this.FullscreenMode)}: {this.FullscreenMode}, {nameof(this.VSyncIndex)}: {this.VSyncIndex}, {nameof(this.Volume)}: {this.Volume}, {nameof(this.ElementsSize)}: {this.ElementsSize}, {nameof(this.Keys)}: {this.Keys}, {nameof(this.Resolution)}: {this.Resolution}";
}